...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { led_lock }]; IO_L18P_T2_A24_15 Sch=led_lock
...
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { sel }]; IO_L10N_T1_D15_14 Sch=sel
